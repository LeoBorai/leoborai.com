	...
	<div class="mt-6 flex items-center">
		<span class="flex min-w-0 flex-auto p-px"
			><input
				...
				required=""
				class="w-full appearance-none rounded-[calc(var(--radius-md)-1px)] bg-white px-3 py-[calc(--spacing(2)-1px)] shadow-md shadow-zinc-800/5 outline outline-zinc-900/10 placeholder:text-zinc-400 focus:ring-4 focus:ring-indigo-500/10 focus:outline-indigo-500 sm:text-sm dark:bg-zinc-700/[0.15] dark:text-zinc-200 dark:outline-zinc-700 dark:placeholder:text-zinc-500 dark:focus:ring-indigo-400/10 dark:focus:outline-indigo-400"
			/></span
		><button
